import { BadgeCheck, BarChart3, ShieldAlert, Target } from 'lucide-react'

const cardDefinitions = [
  { key: 'transactions', label: 'Transactions Checked', icon: BarChart3, tone: 'blue' },
  { key: 'legitimate', label: 'Legitimate', icon: BadgeCheck, tone: 'green' },
  { key: 'blocked', label: 'Attacks Blocked', icon: ShieldAlert, tone: 'red' },
